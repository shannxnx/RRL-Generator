...
export default function Navbar() {
    ...
    return <nav className="w-full h-18 border bg-black flex justify-between items-center">
        ...
        <ul className="flex  gap-10 mr-10 ">
            ...
            <li className="text-white lg:text-[20px] cursor-pointer hover:text-violet-700 lg:block
            hidden md:block">Pricing</li>
            {/*<li className="text-white lg:text-[20px] cursor-pointer hover:text-gray-400">About</li>}*/}
            <li className="text-white lg:text-[20px] cursor-pointer hover:text-violet-700
            lg:block
            ...
            hidden md:block">Logout</li>
                    : <li className="text-white lg:text-2xl cursor-pointer hover:text-violet-700
                    lg:block
            hidden md:block">
